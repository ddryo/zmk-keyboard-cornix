...
- ローカル設定: [boards/jzf/cornix/Kconfig.defconfig](boards/jzf/cornix/Kconfig.defconfig)
...
- 左 central 設定: [boards/jzf/cornix/cornix_left_defconfig](boards/jzf/cornix/cornix_left_defconfig)
- 電池センサー定義: [boards/jzf/cornix/nrf_e73.dtsi](boards/jzf/cornix/nrf_e73.dtsi)
